"""
resources/mongodb.py
---------------------
MongoDB connection singleton — one shared client/pool for the whole process.
No business logic lives here; only client creation, index seeding and a
single convenience helper (`get_or_create_user`) used by the auth layer.
"""
