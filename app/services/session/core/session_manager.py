"""
app/services/session/core/session_manager.py
----------------------------------------------
Business logic for the persistent chat / memory feature.
Replaces app/services/chat_service.py.
"""
...
def send_message(session_id: str, user_id: str, user_content: str) -> ChatResponse:
    ...
    _chat_repo.save_message(session_id=session_id, user_id=user_id, tenant_id=tenant_id, role="user", content=user_content)
    _chat_repo.save_message(session_id=session_id, user_id=user_id, tenant_id=tenant_id, role="assistant", content=reply_text)
