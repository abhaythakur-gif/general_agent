"""
app/agentic/agents/workflow_runner/validator.py
-------------------------------------------------
Validates a workflow's agent graph before execution.
Replaces app/engine/workflow/validator.py.
"""

import re
from app.utils.tools.registry import tool_registry
