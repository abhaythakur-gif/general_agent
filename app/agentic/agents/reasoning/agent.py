"""
app/agentic/agents/reasoning/agent.py
---------------------------------------
Executes a single AgentDefinition against the current workflow state.
Replaces app/engine/agents/executor.py.
"""
...
from app.agentic.factory import build_agent
from app.agentic.agents.reasoning.prompts import generate_prompt, _prompt_data_collector
